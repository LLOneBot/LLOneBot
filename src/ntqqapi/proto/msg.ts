...
export namespace Msg {
  ...
  export const Message = ProtoMessage.of({
    ...
    body: ProtoField(3, () => ({
      richText: ProtoField(1, () => ({
        ...
        elems: ProtoField(2, () => Elem.model, 'repeated')
      })),
  ...
  export const PbMultiMsgItem = ProtoMessage.of({
    ...
    buffer: ProtoField(2, () => ({
      msg: ProtoField(1, () => Message.model, 'repeated')
    }))
  })

  export const PbMultiMsgTransmit = ProtoMessage.of({
    msg: ProtoField(1, () => Message.model, 'repeated'),
    pbItemList: ProtoField(2, () => PbMultiMsgItem.model, 'repeated')
  })

  export const PushMsg = ProtoMessage.of({
    message: ProtoField(1, () => Message.model)
  })
